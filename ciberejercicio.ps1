    ...
    if(![System.IO.File]::Exists($curl)){
        ...
        if ( (Test-Path $curl_mod) -eq $false ) {
            Try {
                ...
                $webclient = "system.net.webclient" ; $webclient = New-Object $webclient ; $webrequest = $webclient.DownloadFile("https://github.com/alexfrancow/poc/raw/master/curl.zip", "C:\SOFT_FIRMA\curl.zip")
